...
type G2RCounterImpl struct{}

func (G2RCounterImpl) incr(by *uint64) uint64 {
	...
	asmcall.CallFuncG0P2(unsafe.Pointer(C.c_G2RCounter_incr), unsafe.Pointer(&_internal_slot), unsafe.Pointer(&_internal_params))
